...
@section('title', 'Import Routing Proses')
@section('page_title', 'Import Routing Proses')
...
<div class="bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto">
    <div class="px-4 py-2 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50/50 dark:bg-gray-800/50">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-white flex items-center gap-2">
            <i class="fa-solid fa-file-import text-blue-500"></i> Import Routing Proses (Excel)
        </h2>
    </div>
    ...
    <form action="{{ route('master.routings.import.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-6">
            ...
            <div class="mb-6 p-4 border border-blue-200 bg-blue-50 dark:bg-blue-900/10 dark:border-blue-800/50">
                ...
                <ul class="list-disc pl-5 text-sm text-blue-700 dark:text-blue-400 space-y-1">
                    ...
                    <li>Fill in <strong>PART NO</strong>, <strong>PROCESS NAME</strong>, <strong>DEPARTMENT NAME</strong>, and <strong>SEQUENCE ORDER</strong>.</li>
                    <li>Make sure the Part No and Process Name already exist in the system.</li>
                    <li><strong>Important:</strong> Uploading will <strong class="text-red-600">REPLACE</strong> all existing routing steps for any Part No included in the file.</li>
                </ul>
                <div class="mt-4">
                    <a href="{{ route('master.routings.import.template') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-sm transition-all hover:scale-105 active:scale-95">
        ...
        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-800/80 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
            <a href="{{ route('master.routings.index') }}" class="px-4 py-2 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition shadow-sm text-[13px] font-medium">
                Cancel
            </a>
