...
<div class="bg-white dark:bg-gray-800 shadow border border-gray-200 dark:border-gray-700 max-w-2xl">
    ...
    <form action="{{ route('master.checkpoints.store') }}" method="POST">
        @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-4 gap-6">
                ...
                <div class="space-y-1 sm:col-span-1">
                    ...
                    <input type="number" id="point_number" name="point_number" required min="1" max="99" value="{{ old('point_number', $nextPoint ?? 1) }}"
                        class="w-full border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-white font-mono font-bold text-center">
                </div>
                ...
                <div class="space-y-1 sm:col-span-3">
                    ...
                    <input type="text" id="check_item" name="check_item" required value="{{ old('check_item') }}" placeholder="Example: Scratch, Dent, Spot Completeness, ..." 
                        class="w-full border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-white">
                </div>
            </div>
        ...
        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-800/80 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
            <a href="{{ route('master.checkpoints.index') }}" class="px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 shadow-sm text-[13px] font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition">
                Cancel
            </a>
            <button type="submit" class="px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white shadow-md shadow-blue-500/20 text-[13px] font-medium hover:from-blue-700 hover:to-cyan-700 transition flex items-center gap-2">
