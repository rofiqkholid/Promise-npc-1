...
<div class="bg-white dark:bg-gray-800 shadow border border-gray-200 dark:border-gray-700">
    <div class="px-4 py-2 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        ...
        <a href="{{ route('master.delivery-targets.create') }}" class="px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white hover:from-blue-700 hover:to-cyan-700 transition shadow-md shadow-blue-500/20 font-medium text-[13px] flex items-center gap-2">
            ...
            <table id="deliveryTargetsTable" class="w-full text-sm text-left text-slate-600 dark:text-slate-400">
                <thead class="bg-gray-100 dark:bg-gray-700/50 text-slate-800 dark:text-slate-200 border-b border-gray-200 dark:border-gray-600 uppercase text-xs tracking-wider">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-2 font-semibold">Target Name</th>
    ...
    $(document).ready(function() {
        initPromiseDataTable('#deliveryTargetsTable', {
            ...
            columns: [
                ...
                { data: 'target_name', name: 'target_name', className: 'px-4 py-2 font-bold text-slate-900 dark:text-white' },
