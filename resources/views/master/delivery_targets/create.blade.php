...
@section('title', 'Add Delivery Target')
@section('page_title', 'Master Data / Delivery Targets / Add New')
...
<div class="bg-white dark:bg-gray-800 shadow border border-gray-200 dark:border-gray-700 max-w-2xl">
    <div class="px-4 py-2 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white">
            <i class="fa-solid fa-plus-circle text-green-600 mr-2"></i> Add Delivery Target Form
        </h2>
    </div>
    ...
    <form action="{{ route('master.delivery-targets.store') }}" method="POST">
        @csrf
        <div class="p-6 space-y-6">
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="target_name" name="target_name" required value="{{ old('target_name') }}"
        ...
        <div class="px-4 py-2 bg-gray-50 dark:bg-gray-800/80 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
            <a href="{{ route('master.delivery-targets.index') }}" class="px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 shadow-sm text-[13px] font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition">
                Cancel
            </a>
