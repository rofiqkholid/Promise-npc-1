...
@section('title', 'Tambah Master Event')
@section('page_title', 'Master Data / Master Events / Tambah')
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-white flex items-center gap-2">
                <i class="fa-solid fa-flag text-blue-500"></i> Form Tambah Master Event
            </h2>
        </div>

        <form action="{{ route('master.events.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="name" required value="{{ old('name') }}"
                    ...
                    placeholder="Contoh: PCLC25-0810 Local Parts Order...">
            ...
            <div class="pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-md shadow-blue-500/20 transition">Simpan Event</button>
            </div>
        </form>
    </div>
</div>
