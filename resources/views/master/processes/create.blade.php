...
@section('title', 'Tambah Master Process')
@section('page_title', 'Master Data / Proses Produksi / Tambah Baru')
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto">
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white">
            <i class="fa-solid fa-plus-circle text-blue-600 mr-2"></i> Formulir Tambah Proses
        </h2>
    </div>
