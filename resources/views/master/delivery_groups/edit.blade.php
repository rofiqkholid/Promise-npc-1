...
@section('title', 'Edit Grup Pengiriman')
@section('page_title', 'Master Data / Grup Pengiriman / Edit')
...
<div class="max-w-2xl bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-white flex items-center gap-2">
            <i class="fa-solid fa-pen-to-square text-blue-500"></i> Edit Grup Pengiriman
        </h2>
    ...
    <form action="{{ route('master.delivery-groups.update', $deliveryGroup->id) }}" method="POST">
        @csrf
        @method('PUT')
