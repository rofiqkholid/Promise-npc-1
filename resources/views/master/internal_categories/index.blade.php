...
<div class="bg-white dark:bg-gray-800 shadow border border-gray-200 dark:border-gray-700">
    <div class="px-4 py-2 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        ...
        <a href="{{ route('master.internal-categories.create') }}" class="px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white hover:from-blue-700 hover:to-cyan-700 transition shadow-md shadow-blue-500/20 font-medium text-[13px] flex items-center gap-2">
    ...
    <div class="p-6">
        ...
        <div class="overflow-x-auto border border-gray-200 dark:border-gray-700">
            <table id="internalCategoriesTable" class="w-full text-sm text-left text-slate-600 dark:text-slate-400">
                <thead class="bg-gray-100 dark:bg-gray-700/50 text-slate-800 dark:text-slate-200 border-b border-gray-200 dark:border-gray-600 uppercase text-xs tracking-wider">
                    <tr>
                        <th scope="col" class="px-4 py-2 font-semibold w-16">No</th>
                        <th scope="col" class="px-4 py-2 font-semibold">Internal Category Name</th>
...
<script>
    $(document).ready(function() {
        initPromiseDataTable('#internalCategoriesTable', {
            ajax: "{{ route('master.internal-categories.index') }}",
            columns: [
