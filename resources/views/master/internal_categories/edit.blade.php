...
@section('title', 'Edit Kategori Internal')
@section('page_title', 'Master Data / Kategori Internal / Edit')
...
<div class="max-w-2xl bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-white flex items-center gap-2">
            <i class="fa-solid fa-pen-to-square text-blue-500"></i> Edit Kategori Internal
        </h2>
    ...
    <form action="{{ route('master.internal-categories.update', $internalCategory->id) }}" method="POST">
        ...
        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3 rounded-b-lg">
            ...
            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-md shadow-blue-500/20 transition">Update Kategori</button>
        </div>
    </form>
</div>
@endsection
