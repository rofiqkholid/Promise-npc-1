...
<div class="bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 max-w-6xl mx-auto">
    <div class="px-4 py-2 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50/50 dark:bg-gray-800/50">
        ...
        <div>
            <a href="{{ route('master.checksheets.index') }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 shadow-sm text-sm font-medium transition dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 border border-gray-300 dark:border-gray-600">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <button type="button" id="add-material-btn" class="text-xs px-2 py-1 bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-900/40 dark:text-blue-400"><i class="fa-solid fa-plus"></i> Add Material</button>
                        </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <button type="button" id="add-std-btn" class="text-xs px-2 py-1 bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-900/40 dark:text-blue-400"><i class="fa-solid fa-plus"></i> Add STD Part</button>
                        </div>
                        <table class="w-full text-sm text-left border border-gray-200 dark:border-gray-700 overflow-hidden">
                            <thead class="bg-gray-100 dark:bg-gray-700/80 text-gray-800 dark:text-gray-200 uppercase text-[10px]">
                                <tr>
