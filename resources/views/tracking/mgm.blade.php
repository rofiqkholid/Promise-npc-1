                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="bg-white dark:bg-gray-800 border-b dark:border-gray-700 hover:bg-blue-50/50 dark:hover:bg-gray-700/30 transition text-sm">
                        <td class="px-6 py-4">
                            ...
                            <div class="text-[10px] text-gray-400 uppercase tracking-widest bg-gray-50 dark:bg-gray-700 px-2 py-0.5 inline-block rounded border border-gray-200 dark:border-gray-600 mb-2">PO: {{ optional($part->event)->po_no }} | CV: {{ optional($part->product->vehicleModel)->name ?? 'Unknown Model' }}</div>
